...
//                "background-color": "transparent"
    ...
    //add active class header other page
    var url_check = (window.location.href);
    var url_find = new URL(url_check);
    var service_find_id = url_find.searchParams.get("service");
    var project_find_id = url_find.searchParams.get("project");
    var catogory_find_id = url_find.searchParams.get("category");
    if(service_find_id){
        $('#service_header_class').addClass("active");
    }
    if(project_find_id || catogory_find_id){
        $('#project_header_class').addClass("active");
    }
